...
//            	System.out.println("date="+date);
            	...
            	//每天檢查過了截止日自動下架
            	if(deadTime <= date) {       		
            		adsvc.updateAd(adVO.getAdNo(), adVO.getAdTitle(), adVO.getAd(), adVO.getAdPic1(), adVO.getAdPic2(), adVO.getAdPic3(), 0, adVO.getPostTime(), adVO.getDeadline());
      ...
      timer = new Timer(); 
      Calendar cal = new GregorianCalendar(2021, Calendar.OCTOBER, 3, 0, 0, 0);
