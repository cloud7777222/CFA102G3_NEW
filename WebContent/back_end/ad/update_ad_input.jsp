									...
									<div class="col-lg-7">
										<div class="p-5">
											...
											<form METHOD="post"
												...
												<div class="form-group">
													<input type="TEXT" name="adTitle" size="20"
														class="form-control form-control-user"
														value="<%=(adVO == null) ? "請輸入廣告標題" : adVO.getAdTitle()%>"
														placeholder="廣告標題" />
												</div>
												<div class="form-group">
													<textarea class="form-control form-control-user" name="ad"
														cols="30" rows="10" placeholder="廣告內容"><%=(adVO == null) ? "請輸入廣告內容" : adVO.getAd()%></textarea>
												</div>
												...
												<div class="form-group row">
													<div class="col-sm-6 ">
														<input class="form-control form-control-user"
															name="postTime" id="f_date1" type="text"
															placeholder="發佈日期">
													</div>
													<div class="col-sm-6">
														<input class="form-control form-control-user"
															name="deadline" id="f_date2" type="text"
															placeholder="截止日期">
													</div>
												</div>
												<hr>
