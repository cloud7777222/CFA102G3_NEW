...
<div class="container">
    ...
    <table class="table table-striped custab">
       ...
       <form action="<%=request.getContextPath()%>/friend/friend" method="POST">
		...
		<button class='btn btn-info btn-xs' type="submit" style="float:right; position: relative; right: -450px; top: -10px; margin-right: 10px;"><i class="fas fa-user-plus"></i>加為好友</button>
		</form>
