...
<div class="container">
    ...
    <table class="table table-striped custab">
        ...
        <button id="btn" class='btn btn-info btn-xs' type="button" style="float:right; position: relative; right: -350px; top: -10px; margin-right: 10px;"><i class="fas fa-user-friends"></i>已是好友</button>
        ...
        <button id="DeleteFriend" class='btn btn-info btn-xs' type="submit" style="float:right; position: relative; right: -270px; top: 20px; margin-right: 10px;display: none;">刪除好友</button>
		</form>
