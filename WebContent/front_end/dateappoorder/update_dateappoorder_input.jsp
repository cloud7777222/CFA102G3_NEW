...
<body>
                    ...
                    <div class="col-lg-5">
                        <div class="dater-form">
                            <form>
                                ...
                                <div class="control-group">
                                    <textarea class="form-control" placeholder="Why you want to become a dater?" required="required"></textarea>
                                </div>
                                <div>
 ...
 <script>
    ...
    initDate();
    function initDate(){
    	selectDate.value=selectDate.value.substring(14,16)=="30"?selectDate.value.substring(0,14)+"60:00":selectDate.value;
    	selectDate.value=selectDate.value.replace("T"," ");
    };
