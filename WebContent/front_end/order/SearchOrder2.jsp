        ...
        <div class="col-md-3">
            <div class="osahan-account-page-left shadow-sm bg-white h-100">
                ...
                <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="orders-tab1"  href="<%=request.getContextPath()%>/order/order.do?action=getOrderStateV&orderstate=1&memberno=3" role="tab" aria-controls="orders" aria-selected="false">已付款</a>
                    </li>
                     <li class="nav-item">
                        <a class="nav-link" id="orders-tab2"  href="<%=request.getContextPath()%>/order/order.do?action=getOrderStateV&orderstate=3&memberno=3" role="tab" aria-controls="orders" aria-selected="false">審核中</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="orders-tab3"  href="<%=request.getContextPath()%>/order/order.do?action=getOrderStateV&orderstate=2&memberno=3" role="tab" aria-controls="orders" aria-selected="false">已取消</a>
                    </li>
                </ul>
            </div>
        </div>	
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-body">
         <form METHOD="post" ACTION="<%=request.getContextPath()%>/order/order.do">
				...
				<input type="hidden" id="memberno" name="memberno" value="3">
