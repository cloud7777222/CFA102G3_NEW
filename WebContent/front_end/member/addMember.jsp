...
<!-- Text input-->
<div class="form-group">
    <label class="col-md-4 control-label" for="MemberPassword">密碼</label>  
    <div class="col-md-4">
    <div class="input-group">
  ...
  <!-- Text input-->
<div class="form-group">
    <label class="col-md-4 control-label" for="MemberPasswordCheck">確認密碼</label>  
    <div class="col-md-4">
    <div class="input-group">
      <input id="MemberPasswordCheck" name="memberPasswordCheck" type="password"  class="form-control input-md">
        </div>
    </div>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <button class="btn btn-success"><span class="glyphicon glyphicon-thumbs-up"></span> 註冊</button>
